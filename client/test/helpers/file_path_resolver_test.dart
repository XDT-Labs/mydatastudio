...
void main() {
  group('FilePathResolver.absolute', () {
    test('returns absolute path by joining localCopyPath + relativePath', () {
      ...
      final file = makeTestFile(path: 'vacation/img.jpg', parent: 'vacation', name: 'img.jpg');
    ...
    test('cloud gdrive:// path passes through unchanged', () {
      final col = _makeCollection(localCopyPath: '/Users/mike/Photos');
      final file = makeTestFile(path: 'gdrive://some-file-id', parent: '', name: 'some-file-id');
      final result = FilePathResolver.absolute(file, col);
    ...
    test('already-absolute path passes through unchanged', () {
      final col = _makeCollection(localCopyPath: '/Users/mike/Photos');
      final file = makeTestFile(path: '/already/absolute/path.jpg', parent: '/already/absolute', name: 'path.jpg');
      final result = FilePathResolver.absolute(file, col);
    ...
    test('falls back to collection.path when localCopyPath is null', () {
      ...
      final file = makeTestFile(path: 'docs/report.pdf', parent: 'docs', name: 'report.pdf');
      final result = FilePathResolver.absolute(file, col);
    ...
    test('handles deeply nested relative paths correctly', () {
      ...
      final file = makeTestFile(path: 'photos/2024/january/img.jpg', parent: 'photos/2024/january', name: 'img.jpg');
      final result = FilePathResolver.absolute(file, col);
