...
Widget _wrap(Widget child) =>
    MaterialApp(home: Scaffold(body: SizedBox(width: _width, child: child)));
...
void main() {
  group('ClusterSectionHeader layout', () {
    ...
    testWidgets('no disclosure control when the view cannot collapse', (
      ...
      await tester.pumpWidget(
        _wrap(const ClusterSectionHeader(label: 'Swans', itemCount: 3)),
      );
