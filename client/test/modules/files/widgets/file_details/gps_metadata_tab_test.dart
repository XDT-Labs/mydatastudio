...
void main() {
  group('GpsMetadataTab', () {
    testWidgets('shows no-data state when exifData is null and file has no coords',
        (tester) async {
      final file = makeTestFile();
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: GpsMetadataTab(exifData: null, file: file),
          ),
        ),
      );
    ...
    testWidgets('shows no-data when file has no coords and exifData empty',
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: GpsMetadataTab(exifData: {}, file: file),
          ),
        ),
      );
      expect(find.text('No GPS data found.'), findsOneWidget);
    ...
    testWidgets('renders lat/lng rows when file has coordinates', (tester) async {
