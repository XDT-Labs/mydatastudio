...
void main() {
  ...
  group('ScannerManager Synchronization Rules', () {
    test('startScanners (Startup) MUST ONLY register scanners and NOT call start()', () async {
      ...
      when(() => mockScanner.start(any(), any(), any(), any())).thenAnswer((_) async => 0);
    ...
    test('startScanner (Manual/New) MUST call start() with force: true', () async {
      final collection = Collection(
        id: 'test-id',
        name: 'Test Collection',
        path: '/test/path',
