...
class $AppUsersTable extends AppUsers with TableInfo<$AppUsersTable, AppUser> {
  ...
  static const VerificationMeta _localStoragePathMeta = const VerificationMeta(
    'localStoragePath',
  );
  @override
  ...
  AppUser map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AppUser.fromDb(
      ...
      localStoragePath:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}local_storage_path'],
          )!,
    );
  }
...
class $CollectionsTable extends Collections
  ...
  static const VerificationMeta _scannerMeta = const VerificationMeta(
    'scanner',
  );
  @override
  ...
  static const VerificationMeta _idTokenMeta = const VerificationMeta(
    'idToken',
  );
  @override
  ...
  Collection map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Collection.fromDb(
      ...
      idToken: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id_token'],
      ),
...
class $EmailsTable extends Emails with TableInfo<$EmailsTable, Email> {
  ...
  Email map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Email.fromDb(
      ...
      to: $EmailsTable.$converterto.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}to'],
        )!,
      ),
      cc: $EmailsTable.$convertercc.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}cc'],
        )!,
      ),
      ...
      labels: $EmailsTable.$converterlabels.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (labels.present) {
      map['labels'] = Variable<String>(
        $EmailsTable.$converterlabels.toSql(labels.value),
      );
    }
    if (headers.present) {
...
class $FilesTable extends Files with TableInfo<$FilesTable, File> {
  ...
  static const VerificationMeta _dateLastModifiedMeta = const VerificationMeta(
    'dateLastModified',
  );
  @override
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index collectionsPathIdx = Index(
    'collections_path_idx',
    'CREATE INDEX collections_path_idx ON collections (path)',
  );
  late final Index collectionsTypeIdx = Index(
    'collections_type_idx',
    'CREATE INDEX collections_type_idx ON collections (type)',
  );
  late final Index emailIdIdx = Index(
    'email_id_idx',
    'CREATE INDEX email_id_idx ON emails (id)',
  );
  late final Index emailCollectionidIdx = Index(
  ...
  late final Index fileParentIdx = Index(
    'file_parent_idx',
    'CREATE INDEX file_parent_idx ON files (parent)',
  );
  late final Index fileCollectionIdIdx = Index(
    'file_collection_id_idx',
    'CREATE INDEX file_collection_id_idx ON files (collection_id)',
  );
  late final Index fileContenttypeIdx = Index(
  ...
  late final Index folderParentIdx = Index(
    'folder_parent_idx',
    'CREATE INDEX folder_parent_idx ON folders (parent)',
  );
  late final Index folderCollectionIdIdx = Index(
